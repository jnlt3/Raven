...
public class Distancer extends AttackAngleCalculator {
    ...
    public Distancer(double battleFieldWidth, double battleFieldHeight) {
    ...
    public double getAttackAngle(Wave wave, Point2D.Double location, Point2D.Double enemyLocation, double currentAngle, double targetVelocity) {
        ...
        if (dir != 0) {
            ...
            double distanceDifference = distance - PREFERRED_DISTANCE;
