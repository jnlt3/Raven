...
public class RavenFlight {
    ...
    public RavenFlight(AdvancedRobot robot) {
        ...
        Node simple = new ConditionalOutNode(new AreaNormNode(new ETP(simpleFormula, 15, 1, 24), SMOOTH_FACTOR), 0, 0.09);
        Node simple2 = new ConditionalOutNode(new AreaNormNode(new ETP(simpleFormula2, 15, 1, 24), SMOOTH_FACTOR), 0, 0.09);

        Node normal = new CacheNode(new AreaNormNode(new ETP(normalFormula, 30, 2, 24), SMOOTH_FACTOR));
        Node decay = new NoInNode(new ConditionalOutNode(new AreaNormNode(new KNNScanNode(2.2, normal), SMOOTH_FACTOR), 0.06, 1));
